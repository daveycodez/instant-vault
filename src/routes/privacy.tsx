        ...
        <div className="prose prose-neutral max-w-none space-y-8">
          <section>
            ...
            <p className="mt-3 leading-relaxed text-muted-foreground">
              instantVault ("we", "our", or "us") is committed to protecting
              your privacy. This Privacy Policy explains how we collect, use,
              disclose, and safeguard your information when you use our backup
              and restore service ("the Service"). By using the Service, you
          ...
          <section>
            ...
            <p className="mt-1 leading-relaxed text-muted-foreground">
              ...
              authentication credentials. We use magic link authentication and
              do not store passwords.
            </p>
            <h3 className="mt-4 font-semibold">2.2 Backup Data</h3>
            <p className="mt-1 leading-relaxed text-muted-foreground">
              We store the database snapshots you create through the Service.
              This data is stored securely and is only accessible through your
          ...
          <section>
            ...
            <p className="mt-3 leading-relaxed text-muted-foreground">
              Your backup data is stored on secure servers with encryption at
              rest and in transit. We implement industry-standard security
              measures including TLS encryption for all data transfers and
              encrypted storage for all backups. Access to backup data is
              strictly controlled and requires authentication through your
              account.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3 leading-relaxed text-muted-foreground">
              ...
              data to third parties. We may disclose your information only in
          ...
          <section>
            ...
            <p className="mt-3 leading-relaxed text-muted-foreground">
              We retain your backup data for as long as your account is active
              and as needed to provide you the Service. You may delete your
              backups at any time through the Service. Upon account deletion,
              all associated data including backups will be permanently removed
          ...
          <section>
            ...
            <p className="mt-3 leading-relaxed text-muted-foreground">
              ...
              <HeroLink
                href="mailto:privacy@instantvault.dev"
                underline="offset"
              >
